"""graders/expert_grader.py — Expert task grader with extreme SLA pressure."""
    ...
    def grade(self, action: Dict[str, Any], step: int, max_steps: int) -> IncidentReward:
        ...
        if step > sla_step:
            ...
            return IncidentReward(
                ...
                is_terminal=True, step=step, task_id="expert",
            )
        return result
